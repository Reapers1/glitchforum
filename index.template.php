	...
	<div id="main-wrapper">
		...
		<div id="toolbar">';
				if ($context['user']['is_logged'])
							...
							<div class="g-facebook"><a href="https://www.facebook.com/LenaRolePlay/" style="color:#fff;"><i class="fa fa-facebook" aria-hidden="true"></i></a></div>
		...
		<div class="icyapi">
			...
			if ($context['user']['is_logged'])
						...
						<div class="pm"><a href="' , $scripturl , '?action=pm" style="color: #fff;" >Özel Mesaj: ', $context['user']['unread_messages'] .'</a></div>
								<div class="veo-avatar"><a href="' , $scripturl , '?action=profile">', $context['user']['avatar']['image'], '</a></div>
								';
						...
						<div class="nickname">Ziyaretçi</div>
							<img class="br64 mr15" width="70" height="70" src="', $settings['default_images_url'], '/default_avatar.png">';
						}
							echo'
			</div>
		</div>
			...
			$forumnick = $context['user']['name'];
			$karakterbul = mysql_num_rows(mysql_query("SELECT * FROM karakterlersikim WHERE charactername = '$forumnick'"));
			if($karakterbul >= 1)
					{
						$k_bul = mysql_query("SELECT * FROM karakterlersikim WHERE charactername = '$forumnick'");
						$ara2 = mysql_fetch_assoc($k_bul);
						$k_adi = $ara2['charactername'];
						$k_skin = $ara2['skin'];
						$k_money = $ara2['money'];
						$k_fight = $ara2['fightstyle'];
						$k_age = $ara2['age'];
						$k_deaths = $ara2['deaths'];
						$k_level = $ara2['level'];
						$k_ac = $ara2['account'];
					}
			...
			echo '
				...
				echo'
				<div class="veo-karakter-adı"><i class="fa fa-user" aria-hidden="true"></i> Karakter: ',$k_adi,'</div>
				<div class="veo-karakter-soygun"><i class="fa fa-trophy" aria-hidden="true"></i> Yaş: ',$k_age,'</div>
				<div class="veo-karakter-tutuklanma"><i class="fa fa-child" aria-hidden="true"></i> Level: ',$k_level,'</div>
				<div class="veo-karakter-seviye"><i class="fa fa-star" aria-hidden="true"></i> Hesap Numarası: ',$k_ac,'</div>
				<div class="veo-karakter-para"><i class="fa fa-money" aria-hidden="true"></i> Para: ',$k_money,'</div>
				<div class="veo-karakter-xp"><i class="fa fa-star" aria-hidden="true"></i> Yaralanma: ',$k_deaths,'</div>
				<div class="veo-karakter-destek"><a href="http://www.lena-roleplay.com/index.php?action=profile" style="color:#fff">Destek Bildirimi</a></div>
				<div class="veo-karakter-bug"><a href="http://www.lena-roleplay.com/index.php?action=profile" style="color:#fff">Bug/Fix Bildirimi</a></div>
				<div class="veo-karakter-ozel"><a href="http://www.lena-roleplay.com/index.php?action=profile" style="color:#fff">VIP Bildirimi</a></div>
				</div>';
			}echo'
			<div id="main">
				<div class="wrapper">
...
function template_body_below()
{
	global $context, $settings, $options, $scripturl, $txt, $modSettings;
		...
		echo '
			<div id="footer">
				<a href ="https://www.zeta.com" target="_blank"><div class="trsamp-logo"></div></a><div class="veo-sitemap">

					<div class="veo-sitemap-in">
					<div class="veo-sitemap-title">Lena Roleplay !</div>
					<div class="veo-sitemap-link"><a href="http://www.lena-roleplay.com/index.php?action=profile"><i class="fa fa-chevron-right" aria-hidden="true" style="color: #03A9F4;"></i> Kullanıcı Sözleşmesi</a></div>
					<div class="veo-sitemap-link"><a href="http://www.lena-roleplay.com/index.php?action=profile"><i class="fa fa-chevron-right" aria-hidden="true" style="color: #03A9F4;"></i> Çerez Kullanım Politikası</a></div>
					</div>
					</div>
					...
					<div class="veo-sitemap-link"><a href="http://www.lena-roleplay.com/index.php?action=profile"><i class="fa fa-chevron-right" aria-hidden="true" style="color: #03A9F4;"></i> Yeni Ticket Gönder</a></div>
					<div class="veo-sitemap-link"><a href="http://www.lena-roleplay.com/index.php?action=profile"><i class="fa fa-chevron-right" aria-hidden="true" style="color: #03A9F4;"></i> Ticketlarım</a></div>
					</div>
					</div>
					...
					<div class="trsamp-smf-footer">
									...
									<div id="copyright">
										<p>Bu Forum Lena Roleplay yetkilileri tarafından sağlanmıştır <b style="color: #2196F3;">!</b> </p>
									</div>
...
function theme_linktree($force_show = false)
{
	...
	<div class="navigate_section">
		<ul>
		<li><a href="http://www.lena-roleplay.com/index.php"><span class="fa fa-home"></span></a></li>';
